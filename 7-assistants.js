...
async function main() {
  try {
    const assistant = await openai.beta.assistants.create({
      name: 'GK Tutor',
      instructions:
        'You are a personal General Knowledge Writing Exam tutor. Please help me pass the test. And also feel free to look stuff up online to help me.',
    ...
    console.log(
      '\nHello there, I am your personal General Knowledge Writing Exam tutor. Ask some complicated questions.\n'
    )
